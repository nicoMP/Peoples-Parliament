...
import Sessions from '@/app/constants/Sessions.json';
import axios from 'axios';
import { baseParliamentUrl } from '@/app/constants/constants';
import { initDatabase, saveBills, getBills, clearOldData, getSessions, saveSessions } from '@/app/src/services/database';
import { ApiBill } from '@/app/src/types/bill';
import { SearchType, RoyalAssentFilter, BillFilterOptions, StatusFilter } from '@/app/src/services/filters/BillFilterService';
import { SEARCH_TYPES } from '@/app/src/services/filters/FilterConstants';
import DateFilterModal from '../../modals/DateFilterModal';
import SearchBar from '../common/SearchBar';
import { FilterIndicatorService } from '@/app/src/services/filters/FilterIndicatorService';
...
export default function BillFilterBar({
  ...
  const handleDateFieldChange = (field: string) => {
    // console.log('BillFilterBar: Date field changed to', field);
  ...
  const handleDateSortChange = (order: 'asc' | 'desc') => {
    // console.log('BillFilterBar: Sort order changed to', order);
